...
# تحويل الوحدات المنزلية لجرامات — مشترك بين تحليل الأكل وتسجيله، عشان «1 توست» أو
# «ملعقة صغيرة نوتيلا» يتحسبوا صح من غير ما المستخدم يكتب جرامات.
_HOUSEHOLD_UNITS = (
    "تحويل الوحدات المنزلية لجرامات (اضرب وزن الوحدة في العدد، وممنوع تحطّ 100جم افتراضي لصنف معدود أو وحدة منزلية):\n"
    "• البيضة ~50 جم • شريحة التوست (بر/أبيض) ~27 جم • رغيف العيش البلدي ~90 جم • نص الرغيف ~45 جم\n"
    "• الكوباية (لبن/عصير) ~250 مل • الكوب زبادي ~120 جم • علبة الزبادي ~100 جم\n"
    "• الملعقة الكبيرة ~15 جم • الملعقة الصغيرة ~5 جم (مهم: «ملعقة صغيرة نوتيلا» = ~5 جم مش أكتر)\n"
    "• طبق الرز/المكرونة ~250 جم • شريحة/قطعة الجبنة ~30 جم • بسكويتة ~12 جم • قطعة ~30 جم\n"
    "• ثمرة الفاكهة المتوسطة (تفاحة ~150، موزة ~120، برتقانة ~130) جم\n"
    "أمثلة: «بيضتين»=100 جم، «كوباية لبن»=250 جم، «1 توست بر»=~27 جم، «ملعقة صغيرة نوتيلا»=~5 جم."
)
...
_LOG_EXTRACT_SYSTEM = (
    ...
    "**راعي الكمية والوحدة بدقة واضرب وزن الوحدة في العدد.**\n"
    + _HOUSEHOLD_UNITS + "\n"

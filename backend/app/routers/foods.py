...
_LIBRARY_ALIASES: dict[str, str] = {
    ...
    # أكلت عامة كانت بتتطابق بالغلط مع نوع أغلى/مختلف (الأقصر نصاً):
    "جبنة": "جبنة بيضاء كاملة الدسم", "جبنه": "جبنة بيضاء كاملة الدسم",  # مش «جبنة قريش»
    "مكرونة": "مكرونة مسلوقة", "مكرونه": "مكرونة مسلوقة", "معكرونة": "مكرونة مسلوقة",  # مش «بشاميل»
    "سمك": "سمك مشوي (بلطي)", "سمكة": "سمك مشوي (بلطي)",  # افتراضي مشوي مش مقلي
}

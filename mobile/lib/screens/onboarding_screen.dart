...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _slides = [
    ...
    _Slide('🩺', 'ملاحظة مهمة',
        'رشاقة أداة توعية لمساعدتك على تتبّع تغذيتك، وليست بديلاً عن استشارة طبيب أو أخصائي تغذية. '
        'لو عندك حالة صحية أو بتاخد دواء، استشير مختصاً قبل أي نظام.'),
  ];
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(s.body,
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 15, color: mutedColor(context), height: 1.6)),
                      ],
                    ),
                  );
                },
